...
- Variables: https://docs.blockscout.com/for-developers/information-and-settings/env-variables

### Current work

- `{"time":"2024-01-02T09:41:40.578Z","severity":"warn","message":"structLogs found in debug_traceTransaction response, you should probably change your INDEXER_INTERNAL_TRANSACTIONS_TRACER_TYPE env value","metadata":{"count":10,"fetcher":"internal_transaction"}}`
